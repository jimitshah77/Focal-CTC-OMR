...
for epoch in range(max_epochs):
    ...
    if epoch % 500 == 0:
        ...
        sample_error_list.append(1. * val_ed / val_count)
        symbol_error_list.append(100. * val_ed / val_len)
        print ('Saving the model...')
        saver.save(sess,args.save_model,global_step=epoch)
        print ('------------------------------')
f = open("/home/k/Desktop/omr/focal_alpha_gamma_point_five/loss_list.txt", 'w')
for loss in loss_list:
    f.write(loss+"\n")
f.close()
f = open("/home/k/Desktop/omr/focal_alpha_gamma_point_five/sample_error_list.txt", 'w')
for sample_error in sample_error_list:
    f.write(sample_error+"\n")
f.close()
f = open("/home/k/Desktop/omr/focal_alpha_gamma_point_five/symbol_error_list.txt", 'w')
for symbol_error in symbol_error_list:
    f.write(symbol_error+"\n")
f.close()
